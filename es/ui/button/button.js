...
Component({
  ...
  didMount: function didMount() {
    ...
    switch (this.props.openType) {
      case 'getPhoneNumber':
        openType = 'getAuthorize';scope = 'phoneNumber';break;
      case 'getUserInfo':
        openType = 'getAuthorize';scope = 'userInfo';break;
      default:
    ...
    this.setData({ openType: openType, scope: scope, attributeCSS: attributeCSS });
  },
